...
Main.Size = UDim2.fromOffset(190, 390)
...
speedFrame.Position = UDim2.new(0, 8, 0, 98)
...
avatarBox.Position = UDim2.new(0, 8, 0, 146)
...
listLabel.Position = UDim2.new(0, 8, 0, 208)
...
refreshBtn.Position = UDim2.new(1, -44, 0, 204)
...
scrollFrame.Size = UDim2.new(1, -16, 0, 88)
scrollFrame.Position = UDim2.new(0, 8, 0, 226)
...
statusLabel.Position = UDim2.new(0, 8, 0, 334)
...
-- ==========================================================
-- ปุ่ม GO และ STOP — define ก่อนทุกอย่างที่จะใช้งาน
-- ==========================================================
local btnRow = Instance.new("Frame", Main)
btnRow.Size = UDim2.new(1, -16, 0, 32)
btnRow.Position = UDim2.new(0, 8, 0, 358)
...
-- ==========================================================
-- selectMode — define หลัง setStopVisible
-- ==========================================================
...
local function doFly(player)
    ...
    local function stopFly()
        ...
        -- รอ 1 frame ก่อนปิด PlatformStand เพื่อป้องกันบัคนอนพื้น
        task.defer(function()
            if hum then
                hum.WalkSpeed = 16
                hum.JumpPower = 50
